...
function modalChange(aChange) {
    ...
    var IP = row[1].innerText;
    document.getElementById('inputIP').value = IP;
    document.getElementById('inputhostname').value = row[2].innerText;
    document.getElementById('inputproduct').value = row[3].innerText;
    document.getElementById('inputapplication').value = row[4].innerText;
    document.getElementById('inputjg').value = row[5].innerText;
    document.getElementById('inputstatus').value = row[6].innerText;
    document.getElementById('inputremark').value = row[7].innerText;
    modal_data.getElementsByClassName("submit")[0].onclick = function () {
        var sendData = {
            "operate": "update",
            "updateIP": IP,
